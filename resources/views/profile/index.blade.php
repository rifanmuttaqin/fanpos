			...
			<div class="card col-sm-8">
				<div class="card-body col-sm-12">
					...
					<div class="form-group">
	                  <input disabled="true" type="text" class="form-control form-control-user" name ="username" id="username" placeholder="Username" value="{{ $data_user->username }}">
	                ...
	                <div class="form-group">
	                  <textarea type="text" class="form-control form-control-user" name="address" id="address" placeholder="Alamat Toko">{{$data_user->address}}</textarea>
	                ...
	                <div class="form-group">
	                  <input type="text" class="form-control form-control-user" name ="full_name" id="full_name" placeholder="Nama" value="{{ $data_user->full_name }}">
